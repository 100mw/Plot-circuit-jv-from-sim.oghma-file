...
def execute_remote_command(host, username, password, port, command):
    # Create SSH client
    ...
    try:
        ...
        ssh_client.connect(hostname=host, port=port, username=username, password=password, timeout=20)
...
# Example usage
host = "10.21.55.3"  # Replace with your VM's IP
username = "alexiarango"
password = "i am a prof"
port = 2223
command = ("powershell.exe -Command \""
           "cd 'C:\\Mac\\Home\\Documents\\Oghma\\v21-9\\56nm_d10_up'; "
           "'C:\\Program Files (x86)\\OghmaNano\\oghma_core.exe --1fit';"
           "echo '1fit executed'\""
)

execute_remote_command(host, username, password, port, command)

command = ("powershell.exe -Command \""
           "cd 'C:\\Mac\\Home\\Documents\\Oghma\\v21-9\\56nm_d10_up'; "
           "'C:\\Program Files (x86)\\OghmaNano\\oghma_core.exe';"
           "echo 'oghma_core executed'\""
)
